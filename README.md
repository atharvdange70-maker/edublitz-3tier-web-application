...
- **GitHub:** [https://github.com/atharvdange70-maker/edublitz-3tier-web-application](https://github.com/atharvdange70-maker/edublitz-3tier-web-application)
- **Clone:**
  ```bash
...
9. Note your **VPC ID** (e.g. `vpc-0b861e8a66aa4295c`).
